    ...
    <div className="container mt-5">
      <div className="card shadow-lg p-4">
        ...
        <p className="lead text-center">
          Security analysts are experts who identify and fix problems within
          security systems by analyzing risks, vulnerabilities, threats, and
          incidents. They perform in-depth security assessments to recommend
          solutions for preventing cyberattacks.
        </p>
      </div>
      ...
      <div className="card mt-4 shadow-sm p-4">
        ...
        <ul className="list-group list-group-flush">
          <li className="list-group-item">
            <strong>Securing the company’s assets:</strong> Protecting sensitive
            data, including customer and employee information.
          </li>
          <li className="list-group-item">
            <strong>Overseeing the systems:</strong> Monitoring and ensuring
            systems are up to date with the latest security patches.
          </li>
          <li className="list-group-item">
            <strong>Performing security assessments:</strong> Conducting
            vulnerability tests and risk analysis to detect weaknesses.
          </li>
          <li className="list-group-item">
            <strong>Analyzing data breaches:</strong> Investigating incidents to
            determine the cause and strengthen security controls.
          </li>
          <li className="list-group-item">
            <strong>Collaborating with third-party vendors:</strong> Ensuring
      ...
      <div className="card mt-4 shadow-sm p-4">
        ...
        <p>
          The median annual wage for Information Security Analysts was{" "}
          <strong>$102,600</strong> in May 2021. Other reports indicate:
        </p>
        <ul className="list-group list-group-flush">
          <li className="list-group-item">
            ZipRecruiter: <strong>$93,645</strong> annually (April 2023)
          </li>
          <li className="list-group-item">
            Glassdoor: <strong>$78,213</strong> annually (April 2023)
          </li>
        </ul>
      </div>
      ...
      <div className="card mt-4 shadow-lg p-4">
        ...
        <p>
          Companies should hire security analysts to protect their sensitive
          information and prevent cyberattacks. With the increasing frequency of
          cyber threats, having dedicated security analysts ensures the
