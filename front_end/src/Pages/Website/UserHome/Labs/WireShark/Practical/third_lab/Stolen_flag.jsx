...
export default function Stolen_flag() {
  ...
  const fileUrl = "/WireShark/Stolen Flag.rar";
  const fileName = "Stolen Flag.rar";

  useEffect(() => {
    document.title = "Stolen Flag";
    injectKeyframes();
  }, []);
  ...
  return (
    <>
      <div className="course-labcc">
        <GoBack_Btn />
        <ShowHint_Btn hintText={"Search for HTTP POST and GET requests."} />
        ...
        <div className="container-labcc">
          <div className="faq-section-labcc">
            <div className="fileViewer">
              <p id="lab-info">
                It all started when I executed a script my friend sent me.
                Shortly after, I noticed strange network activity, yet my files
                appeared untouched—but something didn't feel right. Can you
                trace where my stolen flag went and retrieve it?
              </p>
            </div>
