...
function Quiz() {
  // Initialize state to hold answers and feedback for each question
  ...
  const handleSubmitAnswer = (topicIndex, questionIndex) => {
    ...
    if (
      ...
      document.getElementById(`check-${topicIndex}-${questionIndex}`).disabled = true;
      document.getElementById(`check-${topicIndex}-${questionIndex}`).innerHTML =
              ...
              return (
                <div key={questionIndex} className={styles.questionContainer}>
                  ...
                  <button
                    ...
                    id={`check-${topicIndex}-${questionIndex}`}
                  >
                    Submit Answer
                  </button>
