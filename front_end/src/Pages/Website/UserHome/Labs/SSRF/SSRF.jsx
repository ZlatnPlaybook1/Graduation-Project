            ...
            <div className="content-section">
              <dl className="topics-text">
                ...
                <dd className="fadeInUp faq-body" id="border-left">
                  ...
                  <code>Content-Type: application/x-www-form-urlencoded</code><p></p>
                  <code>Content-Length: 118</code><p></p>
                  <code>stockApi=http://192.168.0.68/admin</code><p></p>
                </dd>
                {/* Single FAQ Area  */}
                <dt className="fadeInUp faq-header">
                ...
                <dd className="fadeInUp faq-body" id="border-left">
                  ...
                  <ul>
                    ...
                    <li>Provide a URL that you control, which redirects to the target URL. Try using different redirect codes, as well as different protocols for the target URL. For example, switching from an http: to https: URL during the redirect has been shown to bypass some anti-SSRF filters.</li>

                  </ul>
                  <h2>SSRF with whitelist-based input filters</h2>
                  ...
                  <ul>
                    <li>URLs can contain whitespace characters, which are ignored by most browsers.</li>
                    <li>URLs can contain control characters, which are ignored by most browsers.</li>
                    <li>URLs can contain multiple slashes, which are treated as a single slash by most browsers.</li>
                    <li>URLs can contain URL encoding, which is decoded by most browsers.</li>
                    <li>URLs can contain IP addresses in decimal, octal, or hexadecimal format.</li>
                  </ul>
                  <h2>Bypassing SSRF filters via open redirection</h2>
                  <p>It is sometimes possible to bypass filter-based defenses by exploiting an open redirection vulnerability.</p>
                  ...
                  <br></br>
                  <br></br>
                  <p>This SSRF exploit works because the application first validates that the supplied stockAPI URL is on an allowed domain, which it is. The application then requests the supplied URL, which triggers the open redirection. It follows the redirection, and makes a request to the internal URL of the attacker's choosing.</p>

                </dd>

                {/* Single FAQ Area  */}
                <dt className="fadeInUp faq-header">
                  <span>Topic 5</span> Finding hidden attack surface for SSRF vulnerabilities
                </dt>
                <dd className="fadeInUp faq-body" id="border-left">
                  ...
                  <h2>Partial URLs in requests</h2>
                  ...
                  <h2>SSRF via the Referer header</h2>
                  ...
                  <p id="ssrf-via-the-referer-header-V2L8">
                    See <a href="https://portswigger.net/web-security/ssrf/blind">Blind SSRF vulnerabilities</a> for examples of vulnerabilities involving the Referer header.
                  </p>
                </dd>
              </dl>
            </div>
