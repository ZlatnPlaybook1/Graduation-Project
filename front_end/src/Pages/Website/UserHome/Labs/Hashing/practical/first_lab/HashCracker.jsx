      ...
      <div className=" w-100 mt-5">
        <div className="container p-0 my-5">
          ...
          <div className="mb-5 text-left">
            ...
            <p>
              A <strong>Hash Cracker</strong> attempts to reverse a hash
              value by comparing it against a predefined dictionary of
          ...
          <div className="mb-5 text-left">
            ...
            <div
              className={`alert ${result.includes("Cracked")
                  ? "alert-success"
                  : "alert-danger"
                }`}
            >
