          ...
          <div className="card shadow-lg">
            <div className="card-body">
              ...
              <div className="mb-5 text-left">
                ...
                <p>
                  Salting is a technique used to enhance the security of
                  password hashing. It involves adding a unique random string
                  (the "salt") to each password before it is hashed. This makes
                  it more difficult for attackers to crack password hashes, even
                  if they have access to a database of hashes.
                </p>
              </div>
