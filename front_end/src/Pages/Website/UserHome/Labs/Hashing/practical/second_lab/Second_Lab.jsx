    ...
    <div className="Custom__body--bg">
      ...
      >
        <div className="hashing__sidebar-header d-flex justify-content-between align-items-center mb-3">
          {!sidebarCollapsed && <h4 className="hashing__sidebar-title">Menu</h4>}
          <button
        ...
        <nav className="hashing__nav">
          <ul className="list-unstyled hashing__nav-list">
            <li>
              <a className="hashing__nav-link d-flex align-items-center" href="#overview">
                <FaInfoCircle />
                {!sidebarCollapsed && <span className="ms-2">Overview</span>}
              </a>
            </li>
            <li>
              <a className="hashing__nav-link d-flex align-items-center" href="#instructions">
                <FaFileDownload />
                {!sidebarCollapsed && <span className="ms-2">Task Instructions</span>}
              </a>
            </li>
            <li>
              <a className="hashing__nav-link d-flex align-items-center" href="#data">
                <FaFileUpload />
                {!sidebarCollapsed && <span className="ms-2">Provided Data</span>}
              </a>
            </li>
            <li>
              <a className="hashing__nav-link d-flex align-items-center" href="#answerFormat">
                <FaCheck />
                {!sidebarCollapsed && <span className="ms-2">Answer Format</span>}
              </a>
            </li>
            <li>
              <a className="hashing__nav-link d-flex align-items-center" href="#insights">
                <FaShieldAlt />
                {!sidebarCollapsed && <span className="ms-2">Cybersecurity Insights</span>}
              </a>
            </li>
            <li>
              <a className="hashing__nav-link d-flex align-items-center" href="#tools">
                <FaFileDownload />
                {!sidebarCollapsed && <span className="ms-2">Helper Tools</span>}
              </a>
            </li>
            <li>
              <button className="btn hashing__nav-btn d-flex align-items-center" onClick={handleGoBack}>
                <FaArrowLeft />
                {!sidebarCollapsed && <span className="ms-2">Go Back</span>}
              </button>
            </li>
            <li>
              <button className="btn hashing__nav-btn d-flex align-items-center" onClick={handleShowHint}>
                <FaLightbulb />
      ...
      <div className="hashing__content">
        ...
        <main className="hashing__main">
          ...
          <header className=" text-center pt-4" id="overview">
            <h1 className="fw-bold text-center main-color mb-2">Cybersecurity Hashing Task</h1>
...
<hr className="mb-5 w-50 mx-auto main-color" />
          ...
          <div className="hashing__instructions mb-4" id="instructions">
            ...
            <button type="button" className="btn-main-color mt-3" data-bs-toggle="modal" data-bs-target="#instructionsModal">
            ...
            <div className="card primary-bg primary-text hover-lift">
              <div className="card-body">
                ...
                <div className="hashing__data-list">
                  <p>
                    <strong className="main-color">Hashed Word 1:</strong> f28b28d536f2db2de59da8a4c1351a49
                  </p>
                  <p>
                    <strong className="main-color">Hashed Word 2:</strong> 6c78a2d3f4cf0521e1f5d29932c1e4f6b9eddb68
                  </p>
                  <p>
                    <strong className="main-color">Hashed Word 3:</strong> ee3a31c0a78bbf35e24bb9bc3d94aaf7e60d7003f0ddefb4b625b415c73b1b2a
                  </p>
                  {/* ...continue for all hashes */}
                </div>
                <button onClick={downloadTxtFile} className="btn-main-color mt-2">
                   Download Full Instructions<FaFileDownload className="ms-2" />
                </button>
              </div>
            </div>
          </div>
          ...
          <div className=" mb-4" id="answerFormat">
            <div className="card primary-bg primary-text hover-lift">
              <div className="card-body">
                <h5 className="card-title hashing__card-title">Answer Format</h5>
  ...
  "data": [
    ...
    ...
          ...
          <div className="hashing__insights mb-4" id="insights">
            <h2 className="text-center main-color fs-3 my-4">Cybersecurity Insights</h2>
              ...
              <div className="card primary-bg secondary-text hover-lift">
                <div className="card-body">
                  ...
                  <p className="card-text">
                    Hashing is fundamental in cybersecurity to secure sensitive data and verify file integrity.
                  </p>
                </div>
              </div>
              <div className="card primary-bg secondary-text hover-lift">
                <div className="card-body">
                  ...
                  <p className="card-text">
                    Using strong algorithms like SHA-256 enhances your data protection.
                  </p>
                </div>
              </div>
              <div className="card primary-bg secondary-text hover-lift">
                <div className="card-body">
                  ...
                  <p className="card-text">
                    Validate your answers, follow the JSON format, and review the task instructions.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="hashing__tools mb-5" id="tools">
            ...
            <div className="row">
              {Tools.map((tool, index) => (
                <div key={index} className="col-xl-3 col-lg-4 col-md-6 col-sm-10 mx-sm-auto mb-4">
                  <div className="card primary-bg  hover-lift h-100">
                    <img src={tool.image} alt={tool.title} className="card-img-top hashing__tool-img" />
                    <div className="card-body">
                      <h5 className="card-title hashing__tool-title">{tool.title}</h5>
                      <p className="card-text hashing__tool-text">{tool.brief}</p>
          ...
          <div className="hashing__upload mb-5">
            <div className="card primary-bg primary-text p-3 hover-lift">
              <div className="card-body">
                <div className="mb-3">
                  <label htmlFor="fileUpload" className="form-label hashing__upload-label">
                    Submit Your Answers
                  </label>
                  <input
                    type="file"
                ...
                <button onClick={handleSubmitAnswers} className="btn-main-color my-1" disabled={isSubmitting}>
            ...
            {score !== null && !isSubmitting && (
              <div className="mt-4 col-lg-10 mx-auto">
                <div className="alert alert-success hashing__score" role="alert">
        ...
        <div className="modal-dialog modal-dialog-scrollable " >
          <div className="modal-content hashing__modal-content">
            <div className="modal-header">
              <h5 className="modal-title hashing__modal-title" id="instructionsModalLabel">
                Detailed Task Instructions
              </h5>
            </div>
            <div className="modal-body hashing__modal-body scrollbar">
              <h6 className="hashing__modal-subtitle">Cybersecurity Hashing Task</h6>
              ...
              <ol className="hashing__modal-list">
                ...
                <li>
                  Hashed Word 3: ee3a31c0a78bbf35e24bb9bc3d94aaf7e60d7003f0ddefb4b625b415c73b1b2a
                </li>
                {/* ...list all hashed words */}
              </ol>
              <hr />
              <h6 className="hashing__modal-subtitle">Required Answer Format:</h6>
...
{`{
  "data": [
    ...
    ...
              ...
              <hr />
              <h6 className="hashing__modal-subtitle">Trainer Instructions:</h6>
              <ol className="hashing__modal-list">
              ...
              <p>
                <strong className="main-color">Note:</strong> Once the task is complete, please submit your answers.
              </p>
            </div>
            <div className="modal-footer">
              <button type="button" className="btn-main-color" data-bs-dismiss="modal">
                Close
              </button>
            </div>
          </div>
