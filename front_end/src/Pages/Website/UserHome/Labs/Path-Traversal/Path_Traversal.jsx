  ...
  return (
    <>
      ...
      <LandingLab
        ...
        courseDescription="Learn how attackers exploit path traversal vulnerabilities in web applications to access unauthorized files and directories, and the techniques used to detect and prevent these attacks."
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="go-to-section">
              <button
                onClick={() =>
                  handleGoToLab("/Path_Traversal/Path_Traversal_labs")
                }
                className="go-to"
              >
                Go To Labs
