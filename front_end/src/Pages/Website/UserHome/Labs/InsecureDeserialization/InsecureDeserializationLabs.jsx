      ...
      <div className="course">
        <div className="container">
          ...
          <div className="row">
            {/* lab1 */}
            <Link
              to="/Insecure_Deserialization/Insecure_Deserialization_Labs/lab1"
            ...
            {/* lab2 */}
            <Link
              to="/Insecure_Deserialization/Insecure_Deserialization_Labs/lab2"
              className="course-card"
            >
              <div className="course-image">
                <img src={Auth_Photo} alt="Lab Cover" />
            ...
            {/* lab3 */}
            <Link
              to="/Insecure_Deserialization/Insecure_Deserialization_Labs/lab3"
              className="course-card"
            >
              <div className="course-image">
                <img src={Auth_Photo} alt="Lab Cover" />
