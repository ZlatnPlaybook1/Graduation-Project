              ...
              <dl className="section-text-lab1">
                ...
                <dd className="fadeInUp faq-body-lab1" id="border-left">
                  <ul>
                    <li>
                      <p>
                        Cookies are data that browsers store in small text files
                        on your computer.
                      </p>
                    </li>
                    <li>
                    ...
                    <li>
                      <p>
                        When you sign in to a web application like Cyberlabs,
                        you won’t need to type your email and password again
                        next time because it stores your credentials in the
                        cookies.
                      </p>
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      belonging to the page are added to the request. This way
                      the server gets the necessary data to "remember"
                      information about users.
                    </li>
                  </ul>
                  {/* <form action="">
                                <input type="text" name="answer" placeholder="Answer Format: **********">
                                <button><i className="fa-regular fa-paper-plane"></i>Submit</button>
                            </form>  */}
                </dd>
                {/* Single FAQ Area  */}
                <dt className="wave-lab1 fadeInUp faq-header-lab1">
                ...
                <dd className="faq-body-lab1" id="border-left">
                  <ul>
                    <li>
                      ...
                      items in your shopping cart or your language preference,
                      so you don’t have to re enter this information each time
                      you visit. Cookies let websites allow users and recollect
                      their individual login information and preferences.
                    </li>
                    <li>
                      <h2>Tracking:</h2> Advertisers use cookies to track your
                      browsing habits and show you ads that are relevant to you
                      based on the sites you visit. E Commerce sites also use
                      cookies to track items users had previously viewed
                      allowing the sites to suggest other goods in which you are
                      interested.
                    </li>
                    <li>
                      <h2>Personalization:</h2> They allow websites to show you
                      content that matches your interests, like suggesting
                      videos or products similar to what you’ve viewed before.
                      It is customized advertising which is the main way cookies
                      are used to personalize your sessions.
                    </li>
                    <li>
                      <h2>Keeping You Logged In:</h2> : Cookies remember your
                      login details, so you don’t need to enter your username
                      and password every time you visit a website.
                    </li>
                    <img src={inLab3} alt="" />
                  </ul>
                </dd>
                ...
                <dd className="faq-body-lab1" id="border-left">
                  <ul>
                    ...
                    <li>
                      You can also add an expiry date (in UTC time). By default,
                    ...
                    <li>
                      ...
                      specify a cookie value when you delete a cookie. Just set
                      the expires parameter to a passed date:
                    </li>
                    <pre>
                      <code>
                        <span>
                    ...
                    <li>
                      First, we create a <span>function</span> that stores the
