...
export default function Third_lab() {
  return (
    <>
      <Header />
      {/* Start Courses  */}
      <div className="course-Third_lab">
        <div className="container-Third_lab">
            ...
            <div className="row-practice">
                <div className="card-Third_lab">
                    <img src={image_1} alt=""/>
                    <div className="card-text-Third_lab">
                        ...
                        <p>The development of robots has significantly transformed our daily lives, industries, and the
                            ...
                            1950s when George Devol invented the Third programmable robot called "Unimate." This marked
